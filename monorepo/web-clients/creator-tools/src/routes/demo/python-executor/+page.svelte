...
<div class="container">
  ...
  <div class="execution-controls">
    <ExecutionModeSelector selectedMode={selectedMode} onChange={handleModeChange} />
  ...
  <div class="panels">
    ...
    <div class="panel repl-panel">
      ...
      <div class="repl-container">
        <PythonREPL codeId={codeId} websocketUrl={websocketUrl} />
      </div>
    </div>
    ...
    <div class="panel state-panel">
      ...
      <div class="state-container">
        <GlobalStateViewer codeId={codeId} websocketUrl={websocketUrl} />
      </div>
    </div>
  </div>
</div>
...
<style>
  ...
  .editor-container, .repl-container, .state-container {
    flex-grow: 1;
    overflow: hidden;
  }
</style> 